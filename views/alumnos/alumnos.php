    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="/materias" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class="">
                <div class="flex items-center justify-between h-24 rounded bg-gray-50 dark:bg-gray-800">
                    ...
                    <a class="text-2xl text-gray-400 dark:text-gray-500" href="/c-estudiante">Crear</a>
                </div>
            </div>
        </div>
        <br>
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        <?php foreach ($students as $student) : ?>
                            ...
                            <td class="px-6 py-4">
                                <?php echo $student['apellido']; ?>
                            </td>
                            <td class="px-6 py-4">
                                <?php echo $student['correo']; ?>
                            </td>
                            <td class="px-6 py-4">
